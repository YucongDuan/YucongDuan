...
| [SOVEREIGN81-Local-Sovereign-Agent-Fabric](https://github.com/YucongDuan/SOVEREIGN81-Local-Sovereign-Agent-Fabric) | Muse Glimmer, Qwen, Gemma, or any other local model is a replaceable **proposal engine**. The model never receives authority merely because it is local. | — | Apache-2.0 | 3 |
| [DIKWP-STRATEGOS-9.5](https://github.com/YucongDuan/DIKWP-STRATEGOS-9.5) | A future autonomous-agent platform for strategic equilibrium, alliance diplomacy, authorized intelligence, negotiation, and defense exchange. | — | Apache-2.0 | 1 |
| [Intent-equilibrium-active-cyber-defense-for-humans-workloads-AI-agents-and-supply-chains.](https://github.com/YucongDuan/Intent-equilibrium-active-cyber-defense-for-humans-workloads-AI-agents-and-supply-chains.) | IntentShield starts from a different premise: cybersecurity is not adequately modeled as a binary contest between a morally correct defender and a morally wrong attacker. Real incidents contain legitimate but incompatible business objectives, cognitive errors, local incentive optimization, identity compromise, automation drift, | — | Apache-2.0 | 1 |
| [JusticeShield-OS-v1.0.0](https://github.com/YucongDuan/JusticeShield-OS-v1.0.0) | Victim-First Autonomous Consequence-Bearing Active Defense and Restitution Control Plane | — | Apache-2.0 | 1 |
| [JusticeShield-STRATEGOS-10.0.0](https://github.com/YucongDuan/JusticeShield-STRATEGOS-10.0.0) | Victim-first, consequence-bearing, restitution-centered active defense and strategic deterrence control plane | — | Apache-2.0 | 1 |
